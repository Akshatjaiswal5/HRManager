...
public class getbyad
{
 public static void main(String args[])
 {
  try
  {
   String aadharCardNumber= Keyboard.in.getString("Enter aadhar:");
   EmployeeManagerInterface da= EmployeeManager.getInstance();
  
   if(da.aadharCardNumberExists(aadharCardNumber))
   System.out.println("Id exists");

   EmployeeInterface d= da.getEmployeeByAadharCardNumber(aadharCardNumber);
